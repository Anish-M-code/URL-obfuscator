...
open_redirect=[ '--- URLS with Redirection Notice ---\n',
                ...
                'https://www.womginx.gq/main/', # Open_redirect in proxy [ No warning ] [ Difficult to detect ]
                'https://wassupwomiwi.herokuapp.com/main/', # Open_redirect in proxy [ No warning ] [ Difficult to detect ]
                'https://womginx.arph.org/main/', # Open_redirect in proxy [ No warning ] [ Difficult to detect ]
